...
<body>
    <!-- CABECERA -->
    <header class="py-3">
        <h1 class="text-center text-light"><span class="badge text-bg-danger">LIBROS</span></h1> 
                            ...
                            <?php 
                                ...
                                if ($result -> num_rows > 0) {
                                    ...
                                    while($row = $result ->fetch_assoc()){
                                        if ($row['estado'] == 1 && $row['cantidad'] > 1) {
                                            $estado = '<h5><span class="badge rounded-pill  bg-success  ">Activo</span></h5>';
                                        }elseif($row['cantidad'] == 0) {
                                            $estado = '<h5><span class="badge rounded-pill bg-danger">Inactivo</span></h5>';
                                        }
                                        ...
                                        echo '<td>'.$estado.'</td>';
                                        echo '<td><img  src="data:image/jpg;base64,'. base64_encode( $row['portada'])  .'" width="70" height="70" alt=""></td>';
                                        echo '<td>';
