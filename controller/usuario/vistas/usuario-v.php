...
<body>
    <!-- CABECERA -->
    <header class="py-3">
        <h1 class="text-center text-light"><span class="badge text-bg-danger ">USUARIOS</span></h1>
                            ...
                            <?php 
                                ...
                                if ($result -> num_rows > 0) {
                                    while($row = $result ->fetch_assoc()){
                                        ...
                                        echo '<td><img  src="data:image/jpg;base64,'. base64_encode( $row['foto'])  .'" width="70" height="70" alt=""></td>';
                                        echo '<td>';
                                        echo '<a class="btn btn-secondary me-md-2" href = "lee.php?id='.$row['id'].'">perfil </a>'; 
